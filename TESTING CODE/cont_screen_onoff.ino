...
void setup(void) {
  ...
  tft.drawRect(title_X, title_Y, title_w, title_h, WHITE);
   ...
   tft.println("Experiment mode..");
   
  expmode.initButton(&tft, 160, 417, 110, 70, WHITE, ILI9341_DARKGREEN, WHITE, ON, 3);
  expmode.drawButton();
 ...
 // p = ts.getPoint(); 
  ...
  if (p.z != -1) {
   ...
   if (change) {
      ...
      expmode.initButton(&tft, 160, 417, 110, 70, WHITE, RED, WHITE, OFF, 3);
      expmode.drawButton();
   }
   }
